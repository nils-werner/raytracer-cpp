...
int main() {
    ...
    auto camera_center = raytracer::point3(0, 0, 0);

    // Calculate the vectors across the horizontal and down the vertical
    // viewport edges.
    auto viewport_u = raytracer::vec3(viewport_width, 0, 0);
    auto viewport_v = raytracer::vec3(0, -viewport_height, 0);
    ...
    auto viewport_upper_left = camera_center -
                               raytracer::vec3(0, 0, focal_length) -
